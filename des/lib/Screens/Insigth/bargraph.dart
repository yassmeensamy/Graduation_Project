      ...
      child: BlocProvider(
        ...
        child: BlocBuilder<TabCubit, TabState>(
          builder: (context, state) {
            final data =
                state.selectedTab == Tab.Monthly ? monthlyData : annuallyData;
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return BarActivity(
                              totalactivity:
                                  data[index].Count!, //activity.totalActivity,
                              totaldays:
                                  state.selectedTab == Tab.Monthly ? 30 : 365,
        ...
        return Row(
          ...
          children: [
            Stack(children: [
              ...
              Positioned(
                left:
                    80, // Adjust the position of the red container horizontally to overlap with the blue container
                child: InkWell(
                  onTap: () {
                  ...
                  child: Container(
                    width:
                        99, // Adjust the width of the red container to extend beyond the blue container
                    height: 38,
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(12),
