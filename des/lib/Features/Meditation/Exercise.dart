import 'package:des/Features/Meditation/Models/ExerciseModel.dart';
...
class ExerciseScreen extends StatelessWidget {
  List<ExerciseModel> Exercise = [
    ExerciseModel(
      ...
      title: 'Meditation',
      Content:
          'Meditation is a practice for cultivating mental clarity, relaxation, and inner peace through focused attention or contemplation',
    ),
    ExerciseModel(
      Image: 'assets/images/rigth.png',
      title: 'Challenge Thougths',
      Content:
          'CBT is a brief, goal-oriented therapy that targets and modifies negative thoughths.',
    )
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        children: [
          ExerciseCard(
            exerciseModel: Exercise[0],
            background: constants.mint,
            startColor: constants.green,
            direction: "left",
            onTap: () {
              Navigator.push(
                context,
          ...
          ExerciseCard(
            exerciseModel: Exercise[1],
            background: constants.babyBlue30,
            startColor: constants.babyBlue,
            direction: "Rigth",
            onTap: () {
              Navigator.push(
                context,
